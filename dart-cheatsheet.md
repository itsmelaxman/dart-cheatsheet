![Dart Cheatsheet](dart-cheetsheet.png?raw=true "Cheatsheet")

# Dart Cheatsheet
A Quick Reference list of most important dart stuffs needed to get started with your Flutter Development Journey
...
###  Example
 ...
 ```dart
    String fullName(){
        ...
        String lastName = "Magarati";
        return '$firstName $lastName'; // returns 'Laxman Magarati'
    }
 ```
...
###  Example
 ...
 ```dart
    ...
    var countryList = ["Nepal","India","China","Bangladesh","Srilanka","Afganisthan"];
    String numLength = numList.length; // result is 6
    String countryLength = countryList.length; // result is 6
    String countryIndex = countryList[1]; // result is 'Nepal'
    String numIndex = numList[0]; // result is 1

    countryList.add("Bhutan"); // Adds a new item to the list.
...
###  Example
 ...
 ```dart
    ...
    printMsg()=> print("Hello Flutter Devs");
...
final fruitList = ["Apple","Banana","Grapes","Mango"]; // A list of fruit
final countrySet = {"Nepal","Bhutan","India","China"}; // A set of country
final credMap = {
    'userName': 'lmagarati',
    'password': 'flutterdev'
...
String _firstName = "Aarya";
String _lastName = "Chaudhary";
String _middleName = "Kumar";

String get fullName => '$_firstName $_middleName $_lastName'; // result: 'Aarya Kumar Chaudhary'
...
var fruitList = ["Apple","Banana","Grapes","Mango"];
...
user['lastName'] = 'Basnet';

// Result: {firstName: Kapil, lastName: Basnet}
...
final email = "lmagarati@gmail.com"; // you can't change the value
final String email = "lmagarati@gmail.com"; // you can't change the value
...
```dart
void main() {
 Person person = Person(firstName:"Laxman",lastName:"Magarati",yearofBirth:2003,weight:50.5);
  print(person.firstName); // output - Laxman
  print(person.lastName); // output - Magarati
  person.age = 2022;
